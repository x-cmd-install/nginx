...
[![x-cmd/install — nginx Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/nginx.svg?lang=zh)](https://x-cmd.com/install/nginx)
...
合计: **218,669** 行代码（覆盖前 5 种语言、共 **421** 个文件）。
...
- **Star**: 31,726 · **Fork**: 8,310 · **开放 issue**: 637 · **贡献者**: 124

## 累计统计

- **发布数**: 31 · **已合并 PR**: 291 · **开放 PR**: 249 · **已关闭 issue**: 422 · **开放 issue**: 215 · **提交数**: 8726
...
_数据快照: `data/card/260925.yml` · 2026-09-25T05:36:37Z._
