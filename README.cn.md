...
- **Star**: 31,623 · **Fork**: 8,303 · **开放 issue**: 628 · **贡献者**: 124

## 累计统计

- **发布数**: 29 · **已合并 PR**: 284 · **开放 PR**: 250 · **已关闭 issue**: 400 · **开放 issue**: 228 · **提交数**: 8716
...
在 [repology.org](https://repology.org/project/nginx) 上共有 **1177** 个发行版报告此项目。**57** 个 ✅ 已是最新上游版本，**705** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260911.yml` · 2026-09-11T19:29:25Z._
