...
[![x-cmd/install — nginx Code Quality Monitoring Repo Card](https://repo.x-cmd.io/nginx.svg?lang=zh)](https://x-cmd.com/install/nginx)
...
- **Star**: 31,698 · **Fork**: 8,306 · **开放 issue**: 631 · **贡献者**: 123

## 累计统计

- **发布数**: 31 · **已合并 PR**: 289 · **开放 PR**: 248 · **已关闭 issue**: 409 · **开放 issue**: 222 · **提交数**: 8721
...
_数据快照: `data/card/260921.yml` · 2026-09-21T05:43:40Z._
