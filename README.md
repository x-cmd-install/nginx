...
- **Releases**: 29 · **Merged PRs**: 284 · **Open PRs**: 252 · **Closed issues**: 400 · **Open issues**: 228 · **Commits**: 8716
...
- **Edit the package entry**: <https://github.com/x-cmd/install/edit/main/nginx.yml> (or whichever path the index uses)
